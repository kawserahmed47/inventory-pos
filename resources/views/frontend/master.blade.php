...
<head>
    ...
    <title>Home - Ecommerce Company Name</title>
    ...
    <!-- Main CSS File -->
    <link rel="stylesheet" href="{{asset('frontend/assets')}}/css/skins/skin-demo-28.css">
    <link rel="stylesheet" href="{{asset('frontend/assets')}}/css/demos/demo-28.css">
    <link rel="stylesheet" href="{{asset('frontend/assets')}}/css/demos/carousel-layout.css">
</head>
